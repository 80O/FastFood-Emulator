package com.eu.habbo.fastfood.console;

import com.eu.habbo.fastfood.console.commands.*;
...
public abstract class ConsoleCommand
{
    ...
    public static void load()
    {
        ...
        addCommand(new ConsolePacketsShownCommand());
        addCommand(new ConsoleTestCommand());
        addCommand(new ConsoleDebugCommand());
    }
    ...
    public static boolean handle(String line)
    {
        ...
        if (message.length > 0)
        {
            ...
            {
                if (!message[0].equalsIgnoreCase("help") && !message[0].equalsIgnoreCase("commands")) System.out.println("Unknown Console Command " + message[0]);
